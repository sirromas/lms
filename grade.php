    ...
    <html>
        <head>
            ...
            <style type="text/css" media="all">
                ...
                .dsR2160 /*agl rulekind: base;*/ { width: 1024px; height: 264px;text-align:center; }
                ...
                #container2 { background-color: #fff; width: 1024px; height: 232px; }
                #container1 { background-color: #000; width: 1026px; height: 238px; border: solid 1px #000265; }
                ...
                #container32 { background-color: #fff; width: 1024px; height: 44px; }
                #container33 { width: 1024px; height: 47px; }
                #container6 { background-color: #000; width: 1024px; height: 47px; }
        ...
        <body>
            ...
            <div id="body"  style="width:1024px;margin:auto;text-align:left;padding-top:25px;">
                <iframe id='page' style="width:1024px;position: absolute; height: 100%; border: none;text-align:left; " src="<?php echo $pageURL; ?>"></iframe>
            </div>
            <br/><br/>
