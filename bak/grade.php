    ...
    <html>
        <head>
            ...
            <style type="text/css" media="all">
                ...
                body { color: #000000; }
                a:hover {  color: #5b88f8;  }
                a.title:hover { color: #000000; font-weight: bold; font-size: 28px; font-weight: bold; }
                a.dictionary:hover { color: #000000;  font-size: 17px; font-weight: normal; }
                a.section:hover { color: #000000;  font-size: 16px; font-weight: normal; }
...
.ds203 /*agl rulekind: base;*/ { font-size: 18px; font-family: serif; }
                ...
                #container8 { width: 685px; height: 46px; }
